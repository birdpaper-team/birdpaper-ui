...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-tencent-qq`, { [`${name}-spin`]: props.spin }]);
