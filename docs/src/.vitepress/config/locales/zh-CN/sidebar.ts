  ...
  "/components/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "评分 <span>Rate</span>", link: "/components/rate" },
        { text: "选择器 <span>Select</span>", link: "/components/select" },
        { text: "验证码 <span>VerifyCode</span>", link: "/components/verifyCode" },
        { text: "日期选择 <span>DatePicker</span>", link: "/components/datePicker" },
        { text: "时间选择 <span>TimePicker</span>", link: "/components/timePicker" },
        { text: "颜色选择 <span>ColorPicker</span>", link: "/components/colorPicker" },
        { text: "数字输入 <span>InputNumber</span>", link: "/components/inputNumber" },
        { text: "标签输入 <span>InputTag</span>", link: "/components/inputTag" },
      ],
    },
    {
      text: "导航",
    ...
    },
    {
      ...
      items: [
        ...
        { text: "气泡确认 <span>Popconfirm</span>", link: "/components/popconfirm" },
