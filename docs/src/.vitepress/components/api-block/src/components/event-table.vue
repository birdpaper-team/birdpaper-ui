<template>
  <bp-table :data>
    <template #columns>
      <bp-table-column :title="locales[lang].EVENT_TABLE.NAME" data-index="name" width="140">
      ...
      <bp-table-column :title="locales[lang].EVENT_TABLE.VERSION" data-index="version">
        <template #cell="{ record }">
