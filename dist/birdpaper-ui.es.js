...
import { ref, computed, watch, openBlock, createElementBlock, normalizeClass, renderSlot, normalizeStyle, createElementVNode, createCommentVNode, getCurrentInstance, reactive as reactive$1, createBlock, Transition, withCtx, resolveComponent, resolveDirective, withDirectives, Fragment, createVNode, toDisplayString, onMounted, toRefs as toRefs$1, vShow, renderList, nextTick, createTextVNode, Teleport, onBeforeUnmount, vModelCheckbox, vModelRadio, isRef as isRef$1, unref } from "vue";
...
const _sfc_main$s = {
  ...
  setup(props, { emit }) {
    ...
    watch(() => props.icon, (val) => btnIcon.value = val, { immediate: true });
    watch(() => props.loading, (val) => btnIcon.value = val ? "ri-loader-fill bp-icon-loading" : props.icon, { immediate: true });
...
function _sfc_render$r(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass($setup.btnDivClass),
    onClick: _cache[0] || (_cache[0] = (...args) => $setup.onClick && $setup.onClick(...args))
  }, [
    $setup.isTextBtn ? (openBlock(), createElementBlock("p", {
      key: 0,
      class: normalizeClass([
        "btn-text",
        `btn-theme-${$props.theme}`,
        { "btn-text-disabled": $setup.isDisabled }
      ])
    }, [
      ...
      style: normalizeStyle(`min-width:${$props.minWidth}px`)
    }, [
      $setup.btnIcon !== "" && !_ctx.$slots.default ? (openBlock(), createElementBlock("span", _hoisted_2$h, [
        createElementVNode("i", {
          class: normalizeClass(["bp-icon-inner", $setup.btnIcon])
        }, null, 2)
      ])) : createCommentVNode("", true),
      _ctx.$slots.default ? (openBlock(), createElementBlock("span", _hoisted_3$e, [
        $setup.btnIcon !== "" ? (openBlock(), createElementBlock("i", {
          key: 0,
          class: normalizeClass(["btn-text-inner-i", $setup.btnIcon])
...
var bpButton = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$r]]);
